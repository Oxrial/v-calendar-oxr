<template>
    <div class="vc-time-picker" :class="[{ 'vc-disabled': isDisabled, 'vc-bordered': showBorder }]">
        <div>
            <svg
                fill="none"
        ...
        <div class="vc-date-time">
            ...
            <div class="vc-time">
                ...
                <div v-if="!is24hr" class="vc-am-pm" :class="{ 'vc-disabled': !(hours >= 0) }">
                    <button :class="{ active: isAM, 'vc-disabled': amDisabled }" type="button" @click.prevent="isAM = true">AM</button>
                    <button :class="{ active: !isAM, 'vc-disabled': pmDisabled }" type="button" @click.prevent="isAM = false">PM</button>
                </div>
            </div>
        </div>
    </div>
