...
export default {
    ...
    computed: {
        ...
        slotArgs() {
            ...
            const inputValue = isRange ? { start: this.inputValues[0], end: this.inputValues[1] } : this.inputValues[0]
            ...
            const inputEvents = isRange ? { start: events[0], end: events[1] } : events[0]
            return {
                inputValue,
                inputEvents,
                isDragging,
    ...
    methods: {
        ...
        onInputUpdate(inputValue, isStart, opts) {
            ...
            const value = this.isRange ? { start: this.inputValues[0], end: this.inputValues[1] || this.inputValues[0] } : inputValue
            const config = {
                type: 'string',
                mask: this.inputMask
            }
